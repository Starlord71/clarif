...
@section('content')
    ...
    @else
        <form method="GET" action="{{ route('reports.index') }}" class="mb-3 flex items-center justify-end gap-2">
            ...
            <table class="clarif-table">
                ...
                <tbody>
                    @foreach ($reports as $report)
                        ...
                        @endphp
                        <tr>
                            <td class="px-4 py-3 font-mono text-xs text-slate-500">#{{ $number }}</td>
